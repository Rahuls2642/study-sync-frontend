...
export const RegisterForm = () => {
  ...
  const onSubmit = (data) => {
    ...
    const registerData = { name: fullName, ...rest };
    mutate(registerData, {
      onSuccess: () => {
  ...
  return (
    <div className="w-full">
      <div className="mb-6">
        <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-1.5 font-['Inter',sans-serif]">Create account</h2>
        <p className="text-sm text-gray-500 font-['Inter',sans-serif]">Let's get you started.</p>
      </div>
